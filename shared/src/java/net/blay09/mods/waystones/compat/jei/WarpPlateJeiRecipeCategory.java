...
//
//    private static final ResourceLocation texture = new ResourceLocation(WaystonesMod.ID, "textures/gui/jei/warp_plate.png");
//    public static final ResourceLocation UID = new ResourceLocation(WaystonesMod.ID, "warp_plate");
//
