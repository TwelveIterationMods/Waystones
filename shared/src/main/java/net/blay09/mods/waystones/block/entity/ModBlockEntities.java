...
public class ModBlockEntities {
    ...
    public static void initialize(BalmBlockEntities blockEntities) {
        waystone = blockEntities.registerBlockEntity(id("waystone"), WaystoneBlockEntity::new, ModBlocks.waystone, ModBlocks.mossyWaystone, ModBlocks.sandyWaystone);
        ...
        warpPlate = blockEntities.registerBlockEntity(id("warp_plate"), WarpPlateBlockEntity::new, ModBlocks.warpPlate);
        portstone = blockEntities.registerBlockEntity(id("portstone"), PortstoneBlockEntity::new, ModBlocks.portstone);
    }
