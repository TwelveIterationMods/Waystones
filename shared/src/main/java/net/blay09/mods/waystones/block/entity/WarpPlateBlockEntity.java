...
public class WarpPlateBlockEntity extends WaystoneBlockEntityBase implements ImplementedContainer {
    ...
    private boolean teleportToWarpPlate(Entity entity, IWaystone targetWaystone, ItemStack targetAttunementStack) {
        return PlayerWaystoneManager.tryTeleportToWaystoneWithWarpItem(entity, targetWaystone, WarpMode.WARP_PLATE, targetAttunementStack, getWaystone())
    ...
    private boolean isReadyForTransientAttunement() {
        return readyForAttunement
                && getItem(0).getItem() == Items.ENDER_PEARL
                && getItem(1).getItem() == Items.AMETHYST_SHARD
                && getItem(2).getItem() == Items.AMETHYST_SHARD
                && getItem(3).getItem() == Items.AMETHYST_SHARD
                && getItem(4).getItem() == Items.AMETHYST_SHARD;
    }
