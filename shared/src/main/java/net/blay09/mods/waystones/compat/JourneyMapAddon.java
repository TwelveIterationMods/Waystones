...
//import net.blay09.mods.waystones.config.WaystonesConfigImpl;
...
//        if (!WaystonesConfig.getActive().displayWaystonesOnJourneyMap()) {
//            return;
//        }
//
//        api.removeAll(WaystonesMod.ID);
//
//        for (IWaystone waystone : event.getWaystones()) {
//            try {
//                Waypoint waypoint = new Waypoint(WaystonesMod.ID, waystone.getName(), waystone.getDimension(), waystone.getPos());
//                waypoint.setEditable(false);
//                waypoint.setPersistent(false);
//                waypoint.setGroup(new WaypointGroup(WaystonesMod.ID, WAYSTONE_GROUP_ID.toString(), "Waystones"));
//                api.show(waypoint);
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
