        ...
        return new RecipeProvider(recipes, advancements) {
            ...
            public void buildRecipes() {
                ...
                shapeless(RecipeCategory.DECORATIONS, ModBlocks.waystones.get(WaystoneTypes.MOSSY_ANDESITE))
                        ...
                        .save(output, "waystones:mossy_waystone_from_vines");

                shapeless(RecipeCategory.DECORATIONS, ModBlocks.waystones.get(WaystoneTypes.MOSSY_ANDESITE))
                        .requires(ModBlocks.waystones.get(WaystoneTypes.ANDESITE))
                        .requires(Blocks.MOSS_BLOCK, 3)
                        .unlockedBy("has_waystone", has(ModBlocks.waystones.get(WaystoneTypes.ANDESITE)))
                        .save(output, "waystones:mossy_waystone_from_moss_blocks");
                ...
                PortstoneTypes.builtinValues().filter(it -> it != PortstoneTypes.UNSCOPED).forEach(this::createPortstoneRecipe);
                SharestoneTypes.builtinValues().forEach(this::createSharestoneRecipe);
                ...
                ModItems.warpStones.forEach((type, _) -> {
            ...
            private void createSharestoneRecipe(BuiltinSharestoneType type) {
                ...
                shapeless(RecipeCategory.DECORATIONS, sharestone)
                        ...
                        .save(output, RecipeBuilder.getDefaultRecipeId(new ItemStackTemplate(sharestone.asItem())).identifier().getPath() + "_from_ruined");
            }

            private void createPortstoneRecipe(BuiltinPortstoneType type) {
