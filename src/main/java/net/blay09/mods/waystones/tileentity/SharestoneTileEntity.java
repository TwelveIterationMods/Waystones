...
public class SharestoneTileEntity extends TileEntity {
            ...
            if (state.getBlock() instanceof WaystoneBlock) {
                ...
                if (half == DoubleBlockHalf.LOWER) {
                    ...
                    if (tileEntity instanceof SharestoneTileEntity) {
                        initializeFromBase(((SharestoneTileEntity) tileEntity));
                    }
                }
            }
        }
    ...
    public void initializeFromBase(SharestoneTileEntity tileEntity) {
    ...
    public void uninitializeWaystone() {
        ...
        if (tileEntity instanceof SharestoneTileEntity) {
            SharestoneTileEntity waystoneTile = (SharestoneTileEntity) tileEntity;
